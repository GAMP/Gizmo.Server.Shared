...
namespace Gizmo.Server.Exceptions
{
    ...
    [Name("Fiscal printer error", "EXCEPTION_TYPE_FISCAL_PRINTER_NAME")]
    [ExtendedDescription("Fiscal printer related error", "EXCEPTION_TYPE_FISCAL_PRINTER_DESCRIPTION")]
